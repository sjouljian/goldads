        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="margin:auto; background: white; padding: 20px; box-shadow: 10px 10px 5px #888;">
                ...
                <form action="process.php" method="post" autocomplete="off">
                    ...
                    <input type="text" name="amount" class="form-control" value="<?php echo $amount; ?>" disable>
                    <br>
                    <label for="email">Email Address</label>
                    <input type="email" name="email" class="form-control" value="<?php echo $email; ?>" disable>
                    <br>
